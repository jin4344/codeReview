            ...
            if (
                ...
                b
                    ...
                    .on("@!mousedown", function (c, d) {
                        return (
                            a(d.target).hasClass("search") ? ((b.stayFocused = !0), null === b.searchSel && (b.searchSel = x(c[0]))) : (O.is(".focused") || c.trigger("focus"), d.preventDefault()), !1
                        );
                    })
                    .on("@change", function () {
                    ...
                    .on("@blur", function () {
                        ...
                        var a = b.editor.html();
                        b.content !== a ? ((b.content = a), m(b, "change", [b.editor]), c.trigger("blur").trigger("change")) : c.trigger("blur"),
                            d.search && (b.search.val(""), b.trigger("search.keypress", !0));
                    }),
                d.search &&
                    b
        ...
        function N(b) {
            ...
            g(function () {
                ...
                b.useInternalCDN &&
                    ...
                    u(c) > 4
                        ? ((z = e.regUnicode), (e.imageType = b.imageType || "png"))
                        : (z = new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + e.unicodeRegexp + ")", "gi"));
            });
        }
        var O = function (a, e) {
            var f = this;
